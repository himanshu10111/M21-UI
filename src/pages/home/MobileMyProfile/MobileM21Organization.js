...
const MobileM21Organization = () => {
  const [isMilestone, setIsMilestone] = useState(1);
  const M21Milestone = () => {
    setIsMilestone((current) => !current);
  };
    ...
    <>
      <Col className="section">
        <Card className="border-0">
          <CardHeader className="border-0 border-bottom bg-white">
            <Col className="col-12 ">
              <Row className="g-2 form">
                <Col className="col-10">
                  <b>My Profile</b>:M21 organization
                </Col>
          ...
          <CardBody>
            <Col className="col-12">
              <Col className="col-12 border-bottom">
                <Row className="g-2 form">
                  <Col className="col-6">My M21 journey</Col>
                  <Col className="col-6 text-primary" onClick={M21Milestone}>
                    My M21 Milestone
                  </Col>
                </Row>
              </Col>
              {!isMilestone && (
                <>
                  <Col className="col-12">
                    <Row className="g-2 form">
                      <Col className="col-12">
                        <FormLabel>dd-mm-yyyy</FormLabel>
                      </Col>
                      <Col className="col-12">
                        <FormLabel>Introductory Done</FormLabel>
                      </Col>
                    </Row>
                  </Col>
                  <Col className="col-12">
              ...
              <Row className="g-2 form">
                <Col className="col-12">
                  <Row className="g-2 form">
                    <Col className="col-12">
                      <Row className="g-2 form">
                        <Col className="col-6">
                          ...
                          <Col className="col-12">Offline/in person</Col>
                        </Col>
                        <Col className="col-6">
                          <FormLabel>Introductory date</FormLabel>
                          <Col className="col-12">DD-MM-YYYY</Col>
                        </Col>
                      </Row>
                    </Col>
                    <Col className="col-12">
                      <FormLabel>Location</FormLabel>
                      <Col className="col-12">Bangalore, Karnataka</Col>
                    </Col>
                    ...
                    <Col className="col-12">
                      <Row className="g-2 form">
                        <Col className="col-4">
                          ...
                          <Col className="col-12">People</Col>
                        </Col>
                        <Col className="col-4">
                          <FormLabel>Country/NRC</FormLabel>
                          <Col className="col-12">India</Col>
                        </Col>
                        <Col className="col-4">
                          <FormLabel>State/SRC</FormLabel>
                          <Col className="col-12">Maharashtra</Col>
                        </Col>
                      </Row>
                    </Col>
                    ...
                    <Col className="col-12">
                      <Row className="g-2 form">
                        <Col className="col-6">
                          ...
                          <Col className="col-12">Nagpur</Col>
                        </Col>
                        <Col className="col-6">
                          <FormLabel>Current responsibilities</FormLabel>
                          <Col className="col-12">Member of NRC</Col>
                        </Col>
                      </Row>
                    </Col>
                    ...
                    <Col className="col-12 border-bottom">
                      <Row className="g-2 form">
                        <Col className="col-10">My Expertise</Col>
                    ...
                    <Col className="col-12">
                      <Row className="g-2 form">
                        <Col className="col-4">
                          <Input
                            disabled
                            className="border-light rounded-5"
                        ...
                        <Col className="col-4">
                          <Input
                            disabled
                            className="border-light text-center rounded-5"
                            placeholder="Artist"
                          />
                        </Col>
                        <Col className="col-4">
                    ...
                    <Col className="col-12 border-bottom">
                      <Row className="g-2 form">
                        <Col className="col-10">My area of interest</Col>
                        <Col className="col-2">Edit</Col>
                      </Row>
                    </Col>
                    <Col className="col-12">
                      <Row className="g-2 form">
                        ...
                        <Col className="col-4">
                          <Input
                            disabled
                            className="border-light text-center rounded-5"
                            placeholder="Agricultural reforms"
                          />
                        </Col>
                      </Row>
                    </Col>
...
export default MobileM21Organization;

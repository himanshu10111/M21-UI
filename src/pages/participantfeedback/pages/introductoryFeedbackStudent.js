...
const IntroductoryFeedbackStudent = () => {
  ...
  const [isEducationalDetail, setIsEducationalDetail] = useState(1);
  ...
  const [educationRelationHolder, setEducationRelationHolder] = useState("");
  const [educationDegreeHolder, setEducationDegreeHolder] = useState("");
  const [institutedNameHolder, setInstituteNameHolder] = useState("");
  ...
  const [eduTaluka, setEduTaluka] = useState("");
  const [eduPinzip, setEduPinzip] = useState("");
  ...
  const educationDetails = {
    educationSector: educationRelationHolder,
    education: educationDegreeHolder,
    university: institutedNameHolder,
    educationCountry: eduCountry,
    educationState: eduState,
    educationCity: eduCity,
    educationDistrict: eduDistrict,
    educationTaluka: eduTaluka,
    eduactionZipcode: eduPinzip,
  };
  ...
  const responsebody = {
    ...
    contactDetailss: contactDetailss,
  ...
  const CopyFromPermenent = () => {
    setHouseNumber(houseNumber);
    setStreetDetailHolder(streetDetailHolder);
    setCountryHolder(countryHolder);
    setStateHolder(stateHolder);
    setCityHolder(cityHolder);
    setDistrictHolder(districtHolder);
    setTalukaHolder(talukaHolder);
    setPinZipHolder(pinzipHolder);
  };

  const StudentFeedbackSubmit = (e) => {
    e.preventDefault();
    ...
    fetch(`${BaseURL}/api/student/feedback/save`, {
      method: "POST",
      headers: {
            ...
            <Col className="form-control border-0">
              <Row className="g-2 form">
                <Form
                  noValidate
                  validated={validated}
                  onSubmit={StudentFeedbackSubmit}
                >
                  <Card className="border-0">
                    <CardHeader className="bg-white border-0">
                      <Col sm="12" className="form-group">
                        <h4>
                          Introductory Participant Feedback Form - Student Wing
                        </h4>
                      </Col>
                    </CardHeader>
                    {isParticipantForm && (
                                ...
                                <Row className="g-2 form">
                                  <Col sm="12">
                                    <h5>
                                      ...
                                      Movement21 introductory meeting.
                                      <br />
                                      <br />
                                      We would be grateful if you could spare 5
                                      mins or less to sharing your feedback and
                                      let us know how was your experience with
                                      us.
                                    </h5>
                                  </Col>
                                  <Col sm="12">
                                    <Row className="g-2 form">
                                      <Col sm="6">
                                        <p>
                                          Click on start button once you are
                                          ready.
                                        </p>
                                      </Col>
                                      <Col sm="6">
                                        <Button onClick={DetailsIntroductory}>
                                          Start
                                        </Button>
                                      </Col>
                                    </Row>
                            ...
                            <Row className="g-2 form">
                              <Col sm="12">
                                ...
                                <ul>
                                  ...
                                  <li>
                                    You can save your responses at anytime and
                                    submit the survey for later
                                  </li>
                                </ul>
                                  ...
                                  <Row className="g-2 form">
                                    <Col sm="12">
                                      <Row className="g-2 form">
                                        ...
                                        <Col sm="12">
                                          <FormLabel>
                                            Name of the person who introduced
                                            you to Movement21.
                                          </FormLabel>
                                        </Col>
                                      </Row>
                                ...
                                <Col className="form-control border-0">
                                  <Col sm="12">
                                    <Row className="g-2 form">
                                      ...
                                      <Col sm="6" className="form-group">
                                        <Button
                                          onClick={IntroductorydetailsNext}
                                        >
                                          Next
                                        </Button>
                                      </Col>
                                    ...
                                    <Col sm="12" className="form-group">
                                      <Row className="g-2 form">
                                        ...
                                        <Col sm="6" className="form-group">
                                          ...
                                          <Col sm="12" className="form-group">
                                            <Input
                                              defaultValue={streetDetailHolder}
                                              onChange={(e) =>
                                        ...
                                        <Col className="form-group" sm="4">
                                          ...
                                          <Col sm="12" className="form-group">
                                            <Input
                                              ...
                                              onChange={(e) =>
                                                setCountryHolder(e.target.value)
                                              }
                                              type="select"
                                              required
                                            >
                                        ...
                                        <Col className="form-group" sm="4">
                                          ...
                                          <Col sm="12" className="form-group">
                                            <Input
                                              ...
                                              onChange={(e) =>
                                                setTalukaHolder(e.target.value)
                                              }
                                              type="select"
                                              required
                                            >
                                        ...
                                        <Col className="form-group" sm="4">
                                          ...
                                          <Col sm="12" className="form-group">
                                            <Input
                                              ...
                                              onChange={(e) =>
                                                setPinZipHolder(e.target.value)
                                              }
                                              type="text"
                                            />
                                          </Col>
                                  ...
                                  <Row className="g-2 form">
                                    ...
                                    <Col sm="4">
                                      <Row className="g-2 form">
                                        ...
                                        <Col sm="6" className="form-group">
                                          <Button onClick={EducationalDetail}>
                                            Next
                                          </Button>
                                        </Col>
                                      </Row>
                              ...
                              <Col className="section">
                                <Col sm="12" className="form-group">
                                  <Row className="g-2 form">
                                    <Col sm="12" className="form-group">
                                      <FormLabel>
                                        How do you related to educational
                                        sector?
                                        <sup className="text-danger">*</sup>
                                      </FormLabel>
                                      <Col sm="12" className="form-group">
                                        <Input
                                          defaultValue={educationRelationHolder}
                                          onChange={(e) =>
                                            setEducationRelationHolder(
                                              e.target.value
                                            )
                                          }
                                          type="select"
                                      ...
                                      <Row className="g-2 form">
                                        <Col sm="6" className="form-group">
                                          ...
                                          <Col sm="12" className="form-group">
                                            <Input
                                              defaultValue={
                                                educationDegreeHolder
                                              }
                                              onChange={(e) =>
                                                setEducationDegreeHolder
                                              }
                                              type="select"
                                              required
                                            >
                                        ...
                                        <Col sm="6" className="form-group">
                                          <FormLabel>
                                            University/Board/School name
                                            <sup className="text-danger">*</sup>
                                          </FormLabel>
                                          <Col sm="12" className="form-group">
                                            <Input
                                              defaultValue={
                                                institutedNameHolder
                                              }
                                              onChange={(e) =>
                                                setInstituteNameHolder(
                                                  e.target.value
                                                )
                                              }
                                              type="select"
                                        ...
                                        <Col sm="12" className="form-group">
                                          <Row className="g-2 form">
                                            ...
                                            <Col sm="4" className="form-group">
                                              ...
                                              >
                                                <Input
                                                  defaultValue={eduState}
                                                  onChange={(e) =>
                                                    setEduState(e.target.value)
                                                  }
                                                  type="select"
                                                  required
                                                >
                                        ...
                                        <Col sm="12" className="form-group">
                                          <Row className="g-2 form">
                                            ...
                                            <Col sm="4" className="form-group">
                                              ...
                                              >
                                                <Input
                                                  defaultValue={eduTaluka}
                                                  onChange={(e) =>
                                                    setEduTaluka(e.target.value)
                                                  }
                                                  type="select"
                                                  required
                                                >
                                            ...
                                            <Col sm="4" className="form-group">
                                              ...
                                              >
                                                <Input
                                                  defaultValue={eduPinzip}
                                                  onChange={(e) =>
                                                    setEduPinzip(e.target.value)
                                                  }
                                                  type="text"
                                                />
                                              </Col>
                                ...
                                <Row className="g-2 form">
                                  ...
                                  <Col sm="4" className="form-group">
                                    <Row className="g-2 form">
                                      ...
                                      <Col sm="6">
                                        <Button onClick={AdditionaldetailNext}>
                                          Next
                                        </Button>
                                      </Col>
                                    </Row>
                                    ...
                                    <Col sm="4" className="form-group">
                                      ...
                                      <Col sm="12" className="form-group">
                                        <Input
                                          ...
                                          onChange={(e) =>
                                            setEducationHolder(e.target.value)
                                          }
                                          type="select"
                                          required
                                        >
                                    ...
                                    <Col sm="4" className="form-group">
                                      ...
                                      <Col sm="12" className="form-group">
                                        <Input
                                          ...
                                          onChange={(e) =>
                                            setProfessionHolder(e.target.value)
                                          }
                                          type="select"
                                          required
                                        >
                                ...
                                <Col sm="12" className="form-group">
                                  <Row className="g-2 form">
                                    <Col sm="4" className="form-group">
                                      ...
                                      <Col sm="12" className="form-group">
                                        <Input
                                          ...
                                          onChange={(e) =>
                                            setSocialExHolder(e.target.value)
                                          }
                                          type="select"
                                          required
                                        >
                                    ...
                                    <Col sm="4" className="form-group">
                                      ...
                                      <Col sm="12" className="form-group">
                                        <Input
                                          defaultValue={fieldExpertiesHolder}
                                          onChange={(e) =>
                                      ...
                                      <Col sm="12" className="form-group">
                                        <small>Domain you are expert in</small>
                                      </Col>
                                    </Col>
                                    <Col sm="4" className="form-group">
                                      <FormLabel>
                                      ...
                                      <Col sm="12" className="form-group">
                                        <Input
                                          defaultValue={fieldInterstHolder}
                                          onChange={(e) =>
                                ...
                                <Row className="g-2 form">
                                  ...
                                  <Col sm="4">
                                    <Row>
                                      ...
                                      <Col sm="6">
                                        <Button onClick={DivercityDetails}>
                                          Next
                                        </Button>
                                      </Col>
                                    </Row>
                        ...
                        <Col sm="12" className="section">
                          <Card className="border-0">
                            ...
                            <CardBody>
                              <Col sm="12" className="form-group">
                                <Row className="g-2 form">
                                  <Col sm="12" className="bg-light form-group">
                                    <FormLabel>
                                  ...
                                  <Col s="12" className="form-group">
                                    <Row className="g-2 form">
                                      <Col sm="3" className="form-group">
                                        ...
                                        <Col sm="12">
                                          <Input
                                            defaultValue={nationalityHolder}
                                            onChange={(e) =>
                                      ...
                                      <Col sm="3" className="form-group">
                                        ...
                                        <Col sm="12" className="form-group">
                                          <Input
                                            defaultValue={socialCategoryHolder}
                                            onChange={(e) =>
                                      ...
                                      <Col sm="3" className="form-group">
                                        ...
                                        <Col sm="12" className="form-group">
                                          <Input
                                            defaultValue={religionPracHolder}
                                            onChange={(e) =>
                            ...
                            <CardBody>
                              <Col className="section">
                                <Col sm="12" className="form-group">
                                  <Row className="g-2 form">
                                    <Col sm="12" className="form-group">
                                      Based on Introductory Meeting select your
                                      option{" "}
                                      <sup className="text-danger">*</sup>
                                    </Col>
                                    <Col
                                    ...
                                    >
                                      ...
                                      />
                                      <FormLabel>
                                        I need some more clarification regarding
                                        Movement21
                                      </FormLabel>
                                    </Col>
                                    <Col
                                  ...
                                  <Col sm="12" className="form-group">
                                    <p>
                                      <h5>
                                        ...
                                        Movement21 introductory meeting and
                                        sharing your feedback. Your feedback is
                                        valuable to us.
                                      </h5>
                                    </p>
                                  </Col>
...
export default IntroductoryFeedbackStudent;

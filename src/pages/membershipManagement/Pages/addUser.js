    ...
    <>
      <Col sm="12">
        <Table striped hover className="col-sm-12">
          ...
          <tbody>
            {rowFormData.map((fromEntryHolder) => (
              <tr key={fromEntryHolder.id}>
                <td>
                  <Input type="checkbox" />
                </td>
                <td>
                  {fromEntryHolder.firstName} &nbsp; {fromEntryHolder.lastName}
                </td>
                <td>{fromEntryHolder.mobileNumber}</td>
                <td>{fromEntryHolder.skill}</td>
                <td>{fromEntryHolder.district}</td>
                <td>{fromEntryHolder.state}</td>
              </tr>
            ))}
          </tbody>
        </Table>
...
const AddUserMemberMangement = (e) => {
  // e.preventDefault()
            ...
            {rowFormData.map((fromEntryHolder) => (
              <tr>
                <td>
                  <Input
                    type="checkbox"
                    key={fromEntryHolder.id}
                    onClick={() =>
                      CollectTheKeyFromTableFirst(fromEntryHolder.id)
                    }
                  />
                </td>
                <td>
                ...
                <td>
                  <Button
                    onClick={CollectTheKeyFromTableThird}
...
export default AddUserMemberMangement;
